...
<dt><b>w˂диапазон˃</b></dt><dd>коэффициент намотки (winding factor). Диапазон от 0 до 1.</dd>
<dt><b>q˂дробь˃</b></dt><dd>число пазов на полюс и фазу (q). Задаётся (пока, жду ваших комментариев) в виде дроби</dd>
...
<dt><b>˂дробь˃</b></dt>
<dd>это пара целых чисел через знак <code>/</code></dd>
</dl>
